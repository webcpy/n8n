    ...
    "cities": {
      ...
      "items": {
        "type": "string"
			...
			{
				displayName:
					"模式必须以<a target='_blank' href='https://json-schema.org/'>JSON Schema</a>格式定义。请查看<a target='_blank' href='https://json-schema.org/learn/miscellaneous-examples.html'>此</a>页面获取示例。",
				name: 'notice',
				type: 'notice',
				default: '',
			},
