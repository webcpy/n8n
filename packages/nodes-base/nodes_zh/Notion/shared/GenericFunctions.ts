...
export function getSearchFilters(resource: string) {
	return [
		...
		{
			"displayName": "<a href=\"https://developers.notion.com/reference/post-database-query#post-database-query-filter\" target=\"_blank\">查看Notion指南</a>以创建过滤器",
			"name": "jsonNotice",
			"type": "notice",
			"displayOptions": {
				"show": {
